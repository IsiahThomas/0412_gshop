<template>
  <div>
    <div class="shopcart">
      <div class="content" @click.stop="isShowCart=!isShowCart">
    ...
    <div class="list-mask" v-if="isShowCart"></div>
  </div>
</template>
<script>
  ...
  export default {
    ...
    computed: {
      ...mapState(['cartFoods','info']),//把state中的这两个东西引过来
      ...mapGetters(['totalCount','totalPrice']),
      //把这两个东西写成计算属性，可以让计算性能更好，因为更新一个东西计算属性就会发生变化
      payClass(){
